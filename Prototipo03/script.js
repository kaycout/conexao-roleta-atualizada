...
function criarRoleta() {
    ...
    new QRCode(document.getElementById("qr-code-container"), { text: window.location.href, width: 150, height: 150 });
...
function adicionar() {
    ...
    let nome = normalizarTexto(document.getElementById("nome").value.trim());
    ...
    // Criando um alert de confirmação para antes de remover um participante
